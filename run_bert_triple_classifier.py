...
def main():
    ...
    # Prepare model
    if not 'PYTORCH_PRETRAINED_BERT_CACHE' in globals():
        PYTORCH_PRETRAINED_BERT_CACHE = os.path.join(str(os.path.expanduser("~")), '.cache', 'pytorch_pretrained_bert')
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                outputs = model(input_ids, token_type_ids=segment_ids, attention_mask=input_mask, labels=None)
